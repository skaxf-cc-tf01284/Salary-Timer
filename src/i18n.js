export const COUNTDOWN_I18N = {
  vi: {
    ...
    workHeadingTemplate: "Countdown Giờ Về (Ca làm 08:00-{endTime}, nghỉ trưa 11:00-12:00, T2-T6, UTC+7)",
    workMilestonePlaceholder: "Countdown đến mốc thời gian kế tiếp...",
    workEndLabel: "Giờ về mục tiêu",
    workEndHintTemplate: "Mặc định 17:00. Hiện tại: <b>{endTime}</b>. Ví dụ: chọn 16:30 nếu muốn về sớm.",
    workEndReset: "Mặc định",
    ...
    segmentLegendAfternoonTemplate: "12:00-{endTime}",
    segmentLegendAfterTemplate: "Sau {endTime}",
    ...
    workDoneScheduleTemplate:
      "Ca làm hôm nay đã hoàn thành. Khung chuẩn: <b>08:00-{endTime}</b>, nghỉ trưa <b>11:00-12:00</b>, đi muộn cho phép đến <b>08:15</b>.",
    ...
    workBeforeStartScheduleTemplate: "Khung chuẩn: <b>08:00-{endTime}</b>, nghỉ trưa <b>11:00-12:00</b>, đi muộn tối đa đến <b>08:15</b>.",
    ...
    workAfternoonScheduleTemplate: "Khung hiện tại: <b>12:00-{endTime}</b>. Kết thúc ca lúc <b>{endTime}</b>.",
    segmentNotApplicable: "Không áp dụng do cuối tuần.",
    segmentLabelAfternoonTemplate: "Khúc hiện tại: Làm buổi chiều (12:00-{endTime})",
    segmentLabelAfterTemplate: "Khúc hiện tại: Sau giờ làm (sau {endTime})",
    segmentTitleAfternoonTemplate: "12:00-{endTime}",
    segmentTitleAfterTemplate: "Sau {endTime}",
    segmentLabels: {
    ...
    milestones: {
      ...
      endWorkTemplate: "Kết thúc ca làm ({endTime})",
  ...
  en: {
    ...
    workHeadingTemplate: "End-of-Work Countdown (Shift 08:00-{endTime}, lunch 11:00-12:00, Mon-Fri, UTC+7)",
    workMilestonePlaceholder: "Counting down to the next milestone...",
    workEndLabel: "Target leave time",
    workEndHintTemplate: "Default is 17:00. Current: <b>{endTime}</b>. Example: choose 16:30 to leave earlier.",
    workEndReset: "Default",
    ...
    segmentLegendAfternoonTemplate: "12:00-{endTime}",
    segmentLegendAfterTemplate: "After {endTime}",
    ...
    workDoneScheduleTemplate:
      "Today's shift is complete. Standard window: <b>08:00-{endTime}</b>, lunch <b>11:00-12:00</b>, late arrival allowed until <b>08:15</b>.",
    ...
    workBeforeStartScheduleTemplate: "Standard window: <b>08:00-{endTime}</b>, lunch <b>11:00-12:00</b>, latest arrival <b>08:15</b>.",
    ...
    workAfternoonScheduleTemplate: "Current window: <b>12:00-{endTime}</b>. Shift ends at <b>{endTime}</b>.",
    segmentNotApplicable: "Not applicable on weekends.",
    segmentLabelAfternoonTemplate: "Current segment: Afternoon work (12:00-{endTime})",
    segmentLabelAfterTemplate: "Current segment: After work (after {endTime})",
    segmentTitleAfternoonTemplate: "12:00-{endTime}",
    segmentTitleAfterTemplate: "After {endTime}",
    segmentLabels: {
    ...
    milestones: {
      ...
      endWorkTemplate: "Shift ends ({endTime})",
